...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Display   : " + huawei.getDisplay() + " " + "inch");
		...
		System.out.println("Display   : " + samsung.getDisplay() + " " + "inch");
		...
		System.out.println("Display   : " + apple.getDisplay() + " " + "inch");
		...
		System.out.println("Display   : " + garmin.getDisplay() + " " + "inch");
